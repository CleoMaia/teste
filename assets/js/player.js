...
window.addEventListener("message", async e => {
	...
	for (var i = 0; i < video_config_media['streams'].length; i++) {
		if (video_config_media['streams'][i].hardsub_lang == user_lang) {
			if (rows_number <= 4) {
				console.log('b', video_m3u8_array)
			...
			if (!found) {
				const status = await UrlExists(video_config_media['streams'][i].url)
				if (status===200) {
	...
	$.ajax({
		...
		complete: response => {
			...
			if (is_ep_premium_only == false) {
				console.log('a', player_current_playlist);
				...
				video_dash_playlist_url = player_current_playlist

				$.ajax({
					async: true,
					type: "GET",
					url: player_current_playlist,
					success: (result, status, xhr) => {
						...
						function linkDownload(id) {
							...
							var video_code = player_current_playlist.split(",")[id];
							var video_mp4_url = player_current_playlist.split("_,")[0] + "_" + video_code + params_download_link;
							u[id] = video_mp4_url;
							pM1[id].resolve();
						}
			...
			function startPlayer() {
				...
				source = [
					{ label: r[1], file: 'https://v.vrv.co/evs1/db4c26cfee449ad7f08598c8bbf2eac4/assets/884c36395d346062e664d285ec4aa6ea_4003792.mp4/index-v1-a1.m3u8?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiaHR0cHM6Ly92LnZydi5jby9ldnMxL2RiNGMyNmNmZWU0NDlhZDdmMDg1OThjOGJiZjJlYWM0L2Fzc2V0cy84ODRjMzYzOTVkMzQ2MDYyZTY2NGQyODVlYzRhYTZlYV8qIiwiQ29uZGl0aW9uIjp7IkRhdGVMZXNzVGhhbiI6eyJBV1M6RXBvY2hUaW1lIjoxNjE2Nzk0MjkzfX19XX0_&Signature=kG3xYXI~mbAQEe8-Agczh9q0Xyq2hxatc6WmUv8791y1HzCRuPyccHJ8OWRJkgfEDAO2u7vYOcrrfH1R1o55E40EUZkJ4xvcvfafweltLkyElFOiJUByGO1QEkYUpO9eIJ5hVz2c3j-Mhk1RMnf0UjD-sYHHDDqDTFFCZSKe0VEmZdLHT690IwovSBJV~y-Nhi7SOy5NMUblrUWzi4ySeIDnZNGToto~DyyCmKL0mmBqsJWg~-KHpGmFXiDB7Rvz2R9Gr-uxjOWCJXFSa8d5MZeoxaBidnKMFGSeM0259x-VoRpi0Td7h3BS8lKzLUlZPdNA5I5aWp3UhNNvxmpa1Q__&Key-Pair-Id=APKAJMWSQ5S7ZB3MF5VA'},
					{ label: r[0], file: 'https://v.vrv.co/evs1/db4c26cfee449ad7f08598c8bbf2eac4/assets/884c36395d346062e664d285ec4aa6ea_4003796.mp4/index-v1-a1.m3u8?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiaHR0cHM6Ly92LnZydi5jby9ldnMxL2RiNGMyNmNmZWU0NDlhZDdmMDg1OThjOGJiZjJlYWM0L2Fzc2V0cy84ODRjMzYzOTVkMzQ2MDYyZTY2NGQyODVlYzRhYTZlYV8qIiwiQ29uZGl0aW9uIjp7IkRhdGVMZXNzVGhhbiI6eyJBV1M6RXBvY2hUaW1lIjoxNjE2Nzk0MjkzfX19XX0_&Signature=kG3xYXI~mbAQEe8-Agczh9q0Xyq2hxatc6WmUv8791y1HzCRuPyccHJ8OWRJkgfEDAO2u7vYOcrrfH1R1o55E40EUZkJ4xvcvfafweltLkyElFOiJUByGO1QEkYUpO9eIJ5hVz2c3j-Mhk1RMnf0UjD-sYHHDDqDTFFCZSKe0VEmZdLHT690IwovSBJV~y-Nhi7SOy5NMUblrUWzi4ySeIDnZNGToto~DyyCmKL0mmBqsJWg~-KHpGmFXiDB7Rvz2R9Gr-uxjOWCJXFSa8d5MZeoxaBidnKMFGSeM0259x-VoRpi0Td7h3BS8lKzLUlZPdNA5I5aWp3UhNNvxmpa1Q__&Key-Pair-Id=APKAJMWSQ5S7ZB3MF5VA'},
					{ label: r[2], file: 'https://v.vrv.co/evs1/db4c26cfee449ad7f08598c8bbf2eac4/assets/884c36395d346062e664d285ec4aa6ea_4003788.mp4/index-v1-a1.m3u8?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiaHR0cHM6